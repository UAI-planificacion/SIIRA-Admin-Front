...
export default function Error404(): React.JSX.Element {
	...
	return (
		<section className="w-full max-w-2xl mx-auto py-16 px-4 flex flex-col items-center justify-center text-center gap-8">
			...
			<div className="space-y-4 max-w-xl">
				<h1 className="text-3xl sm:text-4xl font-extrabold tracking-tight text-foreground">
					Parece que no has encontrado la página que buscabas ☹️
				</h1>
